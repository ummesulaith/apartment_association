 ...
 */
public class DailyReadFeedImageView extends ImageView {
    ...
    public DailyReadFeedImageView(Context context) {
        this(context, null);
    }

    public DailyReadFeedImageView(Context context, AttributeSet attrs) {
