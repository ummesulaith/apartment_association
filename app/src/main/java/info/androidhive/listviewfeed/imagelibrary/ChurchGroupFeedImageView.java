 ...
 */
public class ChurchGroupFeedImageView extends ImageView {
    ...
    public ChurchGroupFeedImageView(Context context) {
        this(context, null);
    }

    public ChurchGroupFeedImageView(Context context, AttributeSet attrs) {
