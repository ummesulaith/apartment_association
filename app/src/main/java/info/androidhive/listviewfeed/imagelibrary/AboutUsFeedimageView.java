 ...
 */
public class AboutUsFeedimageView extends ImageView{
    ...
    public AboutUsFeedimageView(Context context) {
        this(context, null);
    }

    public AboutUsFeedimageView(Context context, AttributeSet attrs) {
