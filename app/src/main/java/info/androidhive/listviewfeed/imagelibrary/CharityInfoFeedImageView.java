package info.androidhive.listviewfeed.imagelibrary;
 ...
 */
public class CharityInfoFeedImageView extends ImageView {
    ...
    public CharityInfoFeedImageView(Context context) {
        this(context, null);
    }

    public CharityInfoFeedImageView(Context context, AttributeSet attrs) {
